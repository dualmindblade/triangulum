...
struct Globals {
    ...
    // hash twin consumes these to evaluate the EXACT cave field. w is the
    // corresponding octave-zero seedmul for the range-biome comparator.
    karst: [u32; 4],
        ...
        let globals = Globals {
            ...
            karst: {
                ...
                [
                    ...
                    kseed(31337),
                    kseed(51413),
                    boundary_shader_seedmul(planet.seed),
                ]
            },
            danchor: {
